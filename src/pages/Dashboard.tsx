          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-blue-600">${stats.monthlyRevenue.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <a href="/orders" className="text-sm text-primary hover:text-primary-dull">View all</a>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <a href="/products" className="text-sm text-primary hover:text-primary-dull">View all</a>
              </div>
            </div>
            <div className="divide-y divide-gray-200">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        ...
                        <p className={`text-xs ${product.stock > 5 ? 'text-green-600' : product.stock > 0 ? 'text-yellow-600' : 'text-red-600'}`}>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <a href="/payments" className="text-sm text-primary hover:text-primary-dull">View all</a>
              </div>
            </div>
                  ...
                  {/* {recentPayments.map((payment) => (
                    <tr key={payment._id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{payment._id}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">View transaction details</p>
                </div>
              </a>
            </div>
          </div>
